...
public class BootMvcProj16FileUploadingAndDownloadingAppApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(BootMvcProj16FileUploadingAndDownloadingAppApplication.class, args);
	}
